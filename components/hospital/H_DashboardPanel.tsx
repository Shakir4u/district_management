...
import { Appointment, Patient, Employee } from '../../hospital-types';
...
interface H_DashboardPanelProps {
...
const H_DashboardPanel: React.FC<H_DashboardPanelProps> = ({ appointments, patients, employees, onUpdateAppointments }) => {
...
export default H_DashboardPanel;